...
public String realizarFotosintesis() {
    return "Realizando la Fotosintesis Perross : )";
}

public String reproducirse() {
    return "Hay dos maneras de reproducción de las plantas: sexual y asexual. Sexual comprende métodos como alogamia, polinización cruzada, dioecia, autogamia, etc. Asexual es mediante técnicas elaboradas por el hombre tales como acodo, estaca, injerto, esqueje, etc.";
}
...
public String devuelveOxigeno() {
    return "Soy un vegetal que devuelve oxígeno para que los seres vivos puedan respirar";
}
//toString()
@Override
public String toString() {
	return "Vegetal [comestible=" + comestible + ", nombre=" + nombre + ", flor=" + flor + ", raiz=" + raiz + ", tallo="
			+ tallo + ", hoja=" + hoja + ", tipo=" + tipo + ", altura=" + altura + "]";
}
